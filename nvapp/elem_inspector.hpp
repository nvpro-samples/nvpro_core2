...
class ElementInspector : public nvapp::IAppElement
{
public:
  ElementInspector();
  ...
  bool updateImageFormat(uint32_t index, const std::vector<nvapp::ElementInspector::ValueFormat>& newFormat);
  ...
  bool updateBufferFormat(uint32_t index, const std::vector<nvapp::ElementInspector::ValueFormat>& newFormat);
  ...
  bool updateComputeFormat(uint32_t index, const std::vector<nvapp::ElementInspector::ValueFormat>& newFormat);
